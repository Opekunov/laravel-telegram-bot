...
use Opekunov\LaravelTelegramBot\Entities\Games\Game;
use Opekunov\LaravelTelegramBot\Entities\Payments\Invoice;
use Opekunov\LaravelTelegramBot\Entities\Payments\SuccessfulPayment;
use Opekunov\LaravelTelegramBot\Entities\TelegramPassport\PassportData;
 ...
 *
 * @method bool isText() Check message is Text
 * @method bool isAudio() Check message is Audio
 * @method bool isAnimation() Check message is Animation
 * @method bool isDocument() Check message is Document
 * @method bool isGame() Check message is Game
 * @method bool isPhoto() Check message is Photo
 * @method bool isSticker() Check message is Sticker
 * @method bool isVideo() Check message is Video
 * @method bool isVoice() Check message is Voice
 * @method bool isVideoNote() Check message is VideoNote
 * @method bool isContact() Check message is Contact
 * @method bool isLocation() Check message is Location
 * @method bool isVenue() Check message is Venue
 * @method bool isPoll() Check message is Poll
 * @method bool isNewChatMembers() Check message is NewChatMembers
 * @method bool isLeftChatMember() Check message is LeftChatMember
 * @method bool isNewChatTitle() Check message is NewChatTitle
 * @method bool isNewChatPhoto() Check message is NewChatPhoto
 * @method bool isDeleteChatPhoto() Check message is DeleteChatPhoto
 * @method bool isGroupChatCreated() Check message is GroupChatCreated
 * @method bool isSupergroupChatCreated() Check message is SupergroupChatCreated
 * @method bool isChannelChatCreated() Check message is ChannelChatCreated
 * @method bool isMessageAutoDeleteTimerChanged() Check message is MessageAutoDeleteTimerChanged
 * @method bool isMigrateToChatId() Check message is MigrateToChatId
 * @method bool isMigrateFromChatId() Check message is MigrateFromChatId
 * @method bool isPinnedMessage() Check message is PinnedMessage
 * @method bool isInvoice() Check message is Invoice
 * @method bool isSuccessfulPayment() Check message is SuccessfulPayment
 * @method bool isPassportData() Check message is PassportData
 * @method bool isProximityAlertTriggered() Check message is ProximityAlertTriggered
 * @method bool isVideoChatScheduled() Check message is VideoChatScheduled
 * @method bool isVideoChatStarted() Check message is VideoChatStarted
 * @method bool isVideoChatEnded() Check message is VideoChatEnded
 * @method bool isVideoChatParticipantsInvited() Check message is VideoChatParticipantsInvited
 * @method bool isWebAppData() Check message is WebAppData
 * @method bool isReplyMarkup() Check message is ReplyMarkup
 */
class Message extends Entity
{
    public function __call($method, $args)
    {
        if (mb_strpos($method, 'is') === 0) {
            $method = str_replace('is', '', $method);
            $type = mb_strtolower(preg_replace('/(?<!^)[A-Z]/', '_$0', $method));
