...
use Opekunov\LaravelTelegramBot\Entities\Payments\PreCheckoutQuery;
use Opekunov\LaravelTelegramBot\Entities\Payments\ShippingQuery;
...
class Update extends Entity
{
    ...
    public function __call($method, $args)
    {
        if (mb_strpos($method, 'is') === 0) {
            ...
            return $type === $this->getUpdateType();
        }
