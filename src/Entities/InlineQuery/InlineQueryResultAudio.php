...
namespace Opekunov\LaravelTelegramBot\Entities\InlineQuery;

use Opekunov\LaravelTelegramBot\Entities\InlineKeyboard;
use Opekunov\LaravelTelegramBot\Entities\InputMessageContent\InputMessageContent;
